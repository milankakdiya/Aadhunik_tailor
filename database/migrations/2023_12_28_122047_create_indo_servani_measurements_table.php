...
class CreateIndoServaniMeasurementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('indo_servani_measurements', function (Blueprint $table) {
            $table->id();
            $table->string('customer_id')->nullable();
            $table->string('indo')->nullable();
            $table->string('servani')->nullable();
    ...
    {
        Schema::dropIfExists('indo_servani_measurements');
    }
}
