...
class CreateKurtaMeasurementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('kurta_measurements', function (Blueprint $table) {
            $table->id();
            $table->string('customer_id')->nullable();
            $table->string('kurta_full')->nullable();
            $table->string('kurta_half')->nullable();
    ...
    {
        Schema::dropIfExists('kurta_measurements');
    }
}
