...
<style>
    ...
    <div class="modal-body">
        <form method="post" id="pent_measurement" enctype="multipart/form-data" action="{{url('bfuyefui_gtqweuy_wgeuy/'. $data->customer_id)}}">  
                            @csrf
                    ...
                    <div class="card flex-row">
                        <div class="form-check form-check-inline w-30 flex-column align-items-start p-3">
                            <div class="d-flex mb-2 input-custom">
                                @if($data->blazer != null)
                                <input class="form-check-input"  type="radio" id="cut_belt" name="belt_type" checked>
                                @else
                                <input class="form-check-input"  type="radio" id="cut_belt" name="belt_type" >
                                @endif
                                <label class="form-check-label" for="cut_belt">Blazer</label>
                            </div>
                            <div class="mobile-w-100">
                                <input class="form-control cut-radio" value="{{$data->blazer}}" type="text" id="id_cut_belt" name="blazer" >
                            </div>
                        </div>
                    
                        <div class="form-check form-check-inline w-30 flex-column align-items-start p-3">
                            <div class="d-flex mb-2 input-custom">
                                @if($data->jodhpuri != null)
                                <input class="form-check-input" type="radio" id="long_belt" name="belt_type" checked>
                                @else
                                <input class="form-check-input" type="radio" id="long_belt" name="belt_type">
                                @endif

                                <label class="form-check-label" for="long_belt">Jodhpuri</label>
                            </div>
                            <div class="mobile-w-100">
                                <input class="form-control cut-redio" value="{{$data->jodhpuri}}" type="text" id="id_long_belt" name="jodhpuri" >
                            </div>
                        </div> 
                    ...
                    <img src="{{asset('images/Pants/Length.png')}}" class="edit_input_img">
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100" >
                                ...
                                <input type="text" class="form-control" width="100%" placeholder="Enter Measurement" value="{{$data->length_measurement}}" name="length_measurement" required>
                                <input type="text" class="form-control ml-3" width="100%" placeholder="Enter Note" value="{{$data->length_notes}}" name="length_notes" required>
                            </div>
                        </div>
                    ...
                    <img src="{{asset('images/Pants/Lower Thai.png')}}" class="edit_input_img">
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100">
                                ...
                                <input type="text" class="form-control" width="100%" value="{{$data->sleeve_length_measurement}}" placeholder="Enter Measurement" name="sleeve_length_measurement" required>
                    ...
                    <img src="{{asset('images/Pants/Calf.png')}}" class="edit_input_img">
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100">
                                <span class="" style="width: 30%">Forearms<span class="text-danger">*</span></span>
                    ...
                    <div class="card  flex-row">
                        ...
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100">
                                ...
                                <input type="text" class="form-control" width="100%" value="{{$data->wrist_measurement}}" placeholder="Enter Measurement" name="wrist_measurement" required>
                                <input type="text" class="form-control ml-3" width="100%" value="{{$data->wrist_notes}}" placeholder="Enter Note" name="wrist_notes" required>
                            </div>
                        </div>
                    ...
                    <div class="card  flex-row">
                        ...
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100">
                                ...
                                <input type="text" class="form-control ml-3" width="100%" value="{{$data->sholders_notes}}" placeholder="Enter Note" name="sholders_notes" required>
                            </div>
                        </div>
                    ...
                    <div class="card  flex-row">
                        ...
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100">
                                ...
                                <input type="text" class="form-control" width="100%" value="{{$data->chest_measurement}}" placeholder="Enter Measurement" name="chest_measurement" required>
                                <input type="text" class="form-control ml-3" width="100%" value="{{$data->chest_notes}}" placeholder="Enter Note" name="chest_notes" required>
                            </div>
                        </div>
                    ...
                    <div class="card  flex-row">
                        ...
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100">
                                ...
                                <input type="text" class="form-control" width="100%" value="{{$data->waist_measurement}}" placeholder="Enter Measurement" name="waist_measurement" required>
                                <input type="text" class="form-control ml-3" width="100%" value="{{$data->waist_notes}}" placeholder="Enter Note" name="waist_notes" required>
                            </div>
                        </div>
                    ...
                    <div class="card  flex-row">
                    <!-- <img src="images/Pants/" class="edit_input_img"> -->
                        <div class="form-check form-check-inline w-100 flex-column align-items-start p-3 justify-content-center">
                            <div class="d-flex align-items-center w-100" >
                                <span class="" style="width: 14%">Add Notes<span class="text-danger">*</span></span>
                                <textarea type="text" value="{{$data->add_notes}}" class="form-control" width="50%" name="add_notes" required>  {{ htmlspecialchars($data->add_notes) }}</textarea>
                            </div>
                        </div>
                    </div> 
