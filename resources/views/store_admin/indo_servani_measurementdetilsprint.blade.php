...
<div>
    <div class="modal-body">
        ...
        <div class="col-11 m-auto">
                <div class="d-flex pdf_card1 mt-3">
                    <div class="w-50 d-flex align-items-baseline">
                        @if($data->indo != null)
                            <label class="w-50 p-2 pdf_card_con1">Indo</label>
                        @else
                        <label class="w-50 p-2 pdf_card_con1">Servani</label>
                        @endif
                        
                        @if($data->indo != null)
                        <span class="w-50 p-2 pdf_card_con1">{{$data->indo}}<span>
                        @else
                        <span class="w-50 p-2 pdf_card_con1">{{$data->servani}}<span>
                        @endif
                    </div> 
                </div>  
                <div class="mt-2">
                    ...
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 p-2 pdf_card_con1">Forearms</label>
...
<div>
    <div class="modal-body" id="pent_measurment_print" style="display: none;">
        ...
        <div class="hader-pants d-flex" style="flex-direction: column;">  
            <div class="w-100" style="text-align:center;font-size: 12px; ">
                Indo/Shervani
            </div>
            <div style="display: flex;justify-content: space-around;">
                <div class="w-30">
                    <div style="font-weight:bold;font-size: 13px;">Customer Id:-  {{$data->customer_id}}</div>
                    <div style="font-weight:bold;font-size: 13px;">Name:- {{$data->customer_name}} </div>
                    <div style="font-weight:bold;font-size: 13px;">Date:- {{ \Carbon\Carbon::parse($data->today_date)->format('d-m-Y') }}</div>
                    
                </div>
                <div class="w-30">
                    <div style="font-weight:bold;font-size: 13px;">Store Code:- {{$data->store_code}}</div>
                    <div style="font-weight:bold;font-size: 13px;">Delivery Date:- {{ \Carbon\Carbon::parse($data->delivery_date)->format('d-m-Y') }}</div> 
                </div>
            </div>
        </div>
        <div class="col-11 m-auto">
            <br>
                <div class="d-flex pdf_card">
                    <div class="w-50 d-flex">
                        @if($data->indo != null)
                            <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Indo</label>
                        @else
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;"> Servani</label>
                        @endif
                        
                        @if($data->indo != null)
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->indo}}<span>
                        @else
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->servani}}<span>
                        @endif
                    </div> 
                </div>  
                <div class="mt-2">
                    ...
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">Sleeve length</label>
                    ...
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">Forearms</label>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
            ...
            <div class="row">
                <div class="col-4 mb-3">
                    <img src="{{ asset('image/' . $data->image_1) }}" alt="" class="w-75 d-flex mx-auto" style="height:auto">
                    <div style="font-size:15px;margin-left:13%">{{$data->image_1_notes}}</div>
                </div>
                <div class="col-4 mb-3">
                    <img src="{{ asset('image/' . $data->image_2) }}" alt="" class="w-75 d-flex mx-auto" style="height:auto">
                    <div style="font-size:15px;margin-left:13%">{{$data->image_2_notes}}</div>
                </div>
                <div class="col-4 mb-3">
                    <img src="{{ asset('image/' . $data->image_3) }}" alt="" class="w-75 d-flex mx-auto" style="height:auto">
                    <div style="font-size:15px;margin-left:13%">{{$data->image_3_notes}}</div>
                </div>
                <div class="col-4 mb-3">
                    <img src="{{ asset('image/' . $data->image_4) }}" alt="" class="w-75 d-flex mx-auto" style="height:auto">
                    <div style="font-size:15px;margin-left:13%">{{$data->image_4_notes}}</div>
                </div>
                <div class="col-4 mb-3">
                    <img src="{{ asset('image/' . $data->image_5) }}" alt="" class="w-75 d-flex mx-auto" style="height:auto">
                    <div style="font-size:15px;margin-left:13%">{{$data->image_5_notes}}</div>
                </div>
                <div class="col-4 mb-3">
                    <img src="{{ asset('image/' . $data->image_6) }}" alt="" class="w-75 d-flex mx-auto" style="height:auto">
...
<div id="pent_image_measurment_print" style="display:none">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
            ...
            <div class="row">
                <div class="col-6">
                 <img src="{{ asset('image/' . $data->image_1) }}" alt="" class="w-100 mt-3" style="height:200px">
                 <div style="font-size:10px;font-weight:bold">{{$data->image_1_notes}}</div>
            </div>
            <div class="col-6">
                 <img src="{{ asset('image/' . $data->image_2) }}" alt="" class="w-100 mt-3" style="height:200px">
                 <div style="font-size:10px;font-weight:bold">{{$data->image_2_notes}}</div>
                </div>
                <div class="col-6">
                <img src="{{ asset('image/' . $data->image_3) }}" alt="" class="w-100 mt-3" style="height:200px">
                <div style="font-size:10px;font-weight:bold">{{$data->image_3_notes}}</div>
            </div>
            <div class="col-6">
               <img src="{{ asset('image/' . $data->image_4) }}" alt="" class="w-100 mt-3" style="height:200px">
               <div style="font-size:10px;font-weight:bold">{{$data->image_4_notes}}</div>
                </div>
                <div class="col-6">
                <img src="{{ asset('image/' . $data->image_5) }}" alt="" class="w-100 mt-3" style="height:200px">
                <div style="font-size:10px;font-weight:bold">{{$data->image_5_notes}}</div>
            </div>
            <div class="col-6">
            <img src="{{ asset('image/' . $data->iamge_6) }}" alt="" class="w-100 mt-3" style="height:200px">
                <div style="font-size:10px;font-weight:bold">{{$data->image_6_notes}}</div>
                </div>
            </div>
</div>
