...
<style>
    ...
    <div class="modal-body">
        <form method="post" id="pent_measurement" enctype="multipart/form-data" action="{{url('vsdgf_asdghd_bsdghdui/'. $data->customer_id)}}">  
                    @csrf
                    ...
                    <div class="hader-pants d-flex"> 
                        ...
                        <div class="w-10">
                            <img src="{{ asset('image/' . $data->customer_image) }}" alt="" width="40px" height="40px" id="cu-image" class="rounded-circle">
                    ...
                    <div class="card flex-row">
                        <div class="form-check form-check-inline w-30 flex-column align-items-start p-3">
                            <div class="d-flex mb-2 input-custom">
                                ...
                                <label class="form-check-label" for="cut_belt">Vest coat</label>
                            </div>
                            <div class="mobile-w-100">
                                <input class="form-control cut-radio" value="{{$data->vest_coat}}" type="text" id="id_cut_belt" name="vest_coat" >
                            </div>
                        </div>
                        ...
                        <div class="form-check form-check-inline w-30 flex-column align-items-start p-3">
                            <div class="d-flex mb-2 input-custom">
                                ...
                                <label class="form-check-label" for="long_belt">Bandi</label>
                            </div>
                            <div class="mobile-w-100">
                                <input class="form-control cut-redio" value="{{$data->bandi}}" type="text" id="id_long_belt" name="bandi" >
                            </div>
                        </div>
                     ...
                     <div class="d-flex justify-content-between">
                        ...
                        <div id="image_notes_container" class="d-flex justify-content-center">
                            <div class="card flex-row image_notes_card" style="padding: 1%;">
                                ...
                                <textarea name="image_notes_2"  style="width: 245px;">{{ htmlspecialchars($data->image_2_notes) }}</textarea>
                            </div>
                        </div>
                        <div id="image_notes_container" class="d-flex justify-content-center">
                            <div class="card flex-row image_notes_card" style="padding: 1%;">
