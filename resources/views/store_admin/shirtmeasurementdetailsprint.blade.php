        ...
        <div class="col-11 m-auto">
                <div class="d-flex pdf_card1">
                    <div class="w-50 d-flex">
                        <label class="w-50 p-2 pdf_card_con1">Opan Shirt Full</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->open_shirts_full}}<span>
                     
                    </div>
                    <div class="w-50 d-flex mx-1">
                        <label class="w-50 p-2 pdf_card_con1">Open Shirt Half</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->opan_shirts_half}}<span>
                    </div>
               
                </div>  
                <div class="d-flex pdf_card1">
                    <div class="w-50 d-flex">
                        <label class="w-50 p-2 pdf_card_con1">Bushirt Full</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->bushirt_full}}<span>
                     
                    </div>
                    <div class="w-50 d-flex mx-1">
                         <label class="w-50 p-2 pdf_card_con1">Bushirt Half</label>
                         <span class="w-50 p-2 pdf_card_con1">{{$data->bushirt_half}}<span>
                    </div>
                ...
                <div class="mt-2">
                    <div class="d-flex pdf_card1">
                        <div class="w-100 d-flex align-items-center bg-row p-1">
                            <label class="w-25 pdf_card_con1"></label>
                            <span class="w-25  pdf_card_con1" style="font-size:15px;font-weight:bold">Measurement</span>
                            <label class="w-75 mt-2 pdf_card_con1" style="font-size:15px;font-weight:bold">Note</label>
                        </div>
                    </div>
                    <div class="pdf_card1">
                    ...
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 p-2 pdf_card_con1">Sleeve length</label>
                        <span class="w-25 p-2 pdf_card_con1">{{$data->sleeve_length_measurement}}</span>
                        <span class="w-75 p-2 pdf_card_con1">{{$data->sleeve_length_notes}}</span>
                    </div>
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 py-2 pdf_card_con1">Half Sleeve Length</label>
                        <span class="w-25 p-2 pdf_card_con1">{{$data->half_sleeve_length_measurement}}</span>
                        <span class="w-75 p-2 pdf_card_con1">{{$data->half_sleeve_length_notes}}</span>
                    </div>
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 p-2 pdf_card_con1">Biceps</label>
                        <span class="w-25 p-2 pdf_card_con1">{{$data->biceps_measurement}}</span>
                        <span class="w-75 p-2 pdf_card_con1">{{$data->biceps_notes}}</span>
                    </div>
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 p-2 pdf_card_con1">Forearm</label>
                        <span class="w-25 p-2 pdf_card_con1">{{$data->forearm_measurement}}</span>
                        <span class="w-75 p-2 pdf_card_con1">{{$data->forearm_notes}}</span>
                    </div>
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 p-2 pdf_card_con1">Wrist</label>
                        <span class="w-25 p-2 pdf_card_con1">{{$data->wrist_measurement}}</span>
                        <span class="w-75 p-2 pdf_card_con1">{{$data->wrist_notes}}</span>
                    </div>
                    <div class="w-100 d-flex align-items-baseline">
    ...
    <div class="modal-body" id="pent_measurment_print" style="display:none">
        ...
        <div class="col-11 m-auto">
                <div class="d-flex pdf_card">
                    <div class="w-50 d-flex">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Opan Shirt Full</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->open_shirts_full}}<span>
                     
                    </div>
                    <div class="w-50 d-flex mx-1">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Open Shirt Half</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->opan_shirts_half}}<span>
                    </div>
               
                </div>  
                <div class="d-flex pdf_card">
                    <div class="w-50 d-flex">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Bushirt Full</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->bushirt_full}}<span>
                     
                    </div>
                    <div class="w-50 d-flex mx-1">
                         <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Bushirt Half</label>
                         <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->bushirt_half}}<span>
                    </div>
                ...
                <div class="mt-2">
                    ...
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">S.L.</label>
                        <span class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">{{$data->sleeve_length_measurement}}</span>
                        <span class="w-75 p-1 pdf_card_con">{{$data->sleeve_length_notes}}</span>
                    </div>
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">H.S.Length</label>
                        <span class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">{{$data->half_sleeve_length_measurement}}</span>
                        <span class="w-75 p-1 pdf_card_con">{{$data->half_sleeve_length_notes}}</span>
                    </div>
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">Biceps</label>
                        <span class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">{{$data->biceps_measurement}}</span>
                        <span class="w-75 p-1 pdf_card_con">{{$data->biceps_notes}}</span>
                    </div>
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">Forearm</label>
                        <span class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">{{$data->forearm_measurement}}</span>
                        <span class="w-75 p-1 pdf_card_con">{{$data->forearm_notes}}</span>
                    </div>
                    <div class="w-100 d-flex">
                        <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">Wrist</label>
                        <span class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px;">{{$data->wrist_measurement}}</span>
                        <span class="w-75 p-1 pdf_card_con">{{$data->wrist_notes}}</span>
                    </div>
                    <div class="w-100 d-flex">
...
<div>
    <div>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
                ...
                <div class="row">
                    ...
                    <div class="col-4 p-3">
                        <img src="{{ asset('image/' . $data->image_2) }}" alt="" class="w-75 d-flex mx-auto" style="height:300px;">
                        <div style="font-size:15px;margin-left:13%">{{$data->image_2_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_3 != null)
                    <div class="col-4 p-3">
                        <img src="{{ asset('image/' . $data->image_3) }}" alt="" class="w-75 d-flex mx-auto" style="height:300px;">
                        <div style="font-size:15px;margin-left:13%">{{$data->image_3_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_4 != null)
                    <div class="col-4 p-3">
                        <img src="{{ asset('image/' . $data->image_4) }}" alt="" class="w-75 d-flex mx-auto" style="height:300px;">
                        <div style="font-size:15px;margin-left:13%">{{$data->image_4_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_5 != null)
                    <div class="col-4 p-3">
                            <img src="{{ asset('image/' . $data->image_5) }}" alt="" class="w-75 d-flex mx-auto" style="height:300px;">
                            <div style="font-size:15px;margin-left:13%">{{$data->image_5_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_6 != null)
                    <div class="col-4 p-3">
                        <img src="{{ asset('image/' . $data->image_6) }}" alt="" class="w-75 d-flex mx-auto" style="height:300px;">
    ...
    <div id="pent_image_measurment_print" style="display:none">
        ...
        <div class="row">
            @if($data->image_1 != null)
            <div class="col-6">
                <img src="{{ asset('image/' . $data->image_1) }}" alt="" class="w-100" style="height:170px">
                <div style="font-size:13px;font-weight:bold" class="mb-3">{{$data->image_1_notes}}</div>
            </div>
            @endif
            @if($data->image_2 != null)
            <div class="col-6">
                <img src="{{ asset('image/' . $data->image_2) }}" alt="" class="w-100" style="height:170px">
                <div style="font-size:13px;font-weight:bold" class="mb-3">{{$data->image_2_notes}}</div>
            </div>
            @endif
            @if($data->image_3 != null)
            <div class="col-6">
                <img src="{{ asset('image/' . $data->image_3) }}" alt="" class="w-100" style="height:170px">
                <div style="font-size:13px;font-weight:bold" class="mb-3">{{$data->image_3_notes}}</div>
            </div>
            @endif
            @if($data->image_4 != null)
            <div class="col-6">
                <img src="{{ asset('image/' . $data->image_4) }}" alt="" class="w-100" style="height:170px">
                <div style="font-size:13px;font-weight:bold" class="mb-3">{{$data->image_4_notes}}</div>
            </div>
            @endif
            @if($data->image_5 != null)
            <div class="col-6">
                    <img src="{{ asset('image/' . $data->image_5) }}" alt="" class="w-100" style="height:170px">
                    <div style="font-size:13px;font-weight:bold" class="mb-3">{{$data->image_5_notes}}</div>
            </div>
            @endif
            @if($data->image_6 != null)
            <div class="col-6">
                <img src="{{ asset('image/' . $data->image_6) }}" alt="" class="w-100" style="height:170px">
                <div style="font-size:13px;font-weight:bold" class="mb-3">{{$data->image_6_notes}}</div>
            </div>
            @endif
        </div>
    </div>
