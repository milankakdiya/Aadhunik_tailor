        ...
        <div class="col-11 m-auto">
                ...
                <div class="d-flex pdf_card1">
                    <div class="w-50 d-flex align-items-baseline mt-3">
                        <label class="w-50 p-2 pdf_card_con1">Kurta Full</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->kurta_full}}<span>
                  
                      
                    </div>
                    <div class="w-50 d-flex align-items-baseline mt-3">
                        <label class="w-50 p-2 pdf_card_con1">Kurta Half</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->kurta_half}}<span>
                    </div>
                </div>  
                ...
                <div class="mt-2">
                    ...
                    <div class="w-100 d-flex align-items-baseline">
                        <label class="w-25 px-xl-2 px-sm-0 py-2 pdf_card_con1">Half Sleeve Length</label>
        ...
        <div class="col-11 m-auto">
                ...
                <div class="d-flex pdf_card">
                    <div class="w-50 d-flex">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px">Kurta Full</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px">{{$data->kurta_full}}<span>
                    </div>
                    <div class="w-50 d-flex">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px">Kurta Half</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px">{{$data->kurta_half}}<span>
                    </div>
                </div>  
                ...
                <div class="mt-2">
                    <div class="pdf_card"> 
                        ...
                        <div class="w-100 d-flex">
                            <label class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px">Half Sleeve Length</label>
