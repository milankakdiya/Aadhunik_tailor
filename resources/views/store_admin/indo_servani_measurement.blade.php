...
<style>
    ...
    <div class="modal-body">
        <form method="post" id="pent_measurement" enctype="multipart/form-data" action="{{url('bsdsh_fwyq_rtyu/'. $data->customer_id)}}">  
                            @csrf
                    ...
                    <div class="card flex-row">
                        <div class="form-check form-check-inline w-30 flex-column align-items-start p-3">
                            <div class="d-flex mb-2 input-custom">
                                ...
                                @endif
                                <label class="form-check-label" for="cut_belt">Indo</label>
                            </div>
                            <div class="mobile-w-100">
                                <input class="form-control cut-radio" value="{{$data->indo}}" type="text" id="id_cut_belt" name="indo" >
                            </div>
                        </div>
                    
                        <div class="form-check form-check-inline w-30 flex-column align-items-start p-3">
                            <div class="d-flex mb-2 input-custom">
                                @if($data->servani != null)
                                ...
                                @endif
                                <label class="form-check-label" for="long_belt">Servani</label>
                            </div>
                            <div class="mobile-w-100">
                                <input class="form-control cut-redio" value="{{$data->servani}}" type="text" id="id_long_belt" name="servani" >
                            </div>
                        </div>
