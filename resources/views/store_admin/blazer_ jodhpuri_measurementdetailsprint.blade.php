        ...
        <div class="col-11 m-auto">
                ...
                <div class="d-flex pdf_card1">
                    <div class="w-50 d-flex align-items-baseline mt-3">
                        <label class="w-50 p-2 pdf_card_con1">Blazer</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->blazer}}&nbsp;<span>
                       
                    </div>   
                    <div class="w-50 d-flex align-items-baseline mt-3">
                        <label class="w-50 p-2 pdf_card_con1">Jodhpuri</label>
                        <span class="w-50 p-2 pdf_card_con1">{{$data->jodhpuri}}&nbsp;<span>
                    </div>
                </div>  
    ...
    <div class="modal-body" id="pent_measurment_print" style="display:none">
        ...
        <div class="col-11 m-auto">
                <div class="d-flex pdf_card">
                    <div class="w-50 d-flex align-items-baseline mt-3">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Blazer</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->blazer}}&nbsp;<span>
                    
                    </div>
                    <div class="w-50 d-flex align-items-baseline mt-3">
                        <label class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">Jodhpuri</label>
                        <span class="w-50 p-2 pdf_card_con" style="font-weight:bold;font-size: 13px;">{{$data->jodhpuri}}&nbsp;<span>
                    </div>
                </div>  
                ...
                <div class="mt-2">
                    ...
                    <div class="w-100 d-flex">
                        ...
                        <span class="w-25 p-1 pdf_card_con" style="font-weight:bold;font-size: 15px">{{$data->forearms_measurement}}</span>
                        <span class="w-75 p-1 pdf_card_con">{{$data->forearms_notes}}</span>
                    </div>
                    <div class="w-100 d-flex">
...
<div id="pent_image_measurment_print" style="display:none">
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
                ...
                <div class="row">
                    @if($data->image_1 != null)
                    <div class="col-6">
                        <img src="{{ asset('image/' . $data->image_1) }}" alt="" class="w-100" style="height:200px">
                        <div style="font-size:10px;font-weight:bold" class="mb-3">{{$data->image_1_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_2 != null)
                    <div class="col-6">
                        <img src="{{ asset('image/' . $data->image_2) }}" alt="" class="w-100" style="height:200px">
                        <div style="font-size:10px;font-weight:bold" class="mb-3">{{$data->image_2_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_3 != null)
                    <div class="col-6">
                        <img src="{{ asset('image/' . $data->image_3) }}" alt="" class="w-100" style="height:200px">
                        <div style="font-size:10px;font-weight:bold" class="mb-3">{{$data->image_3_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_4 != null)
                    <div class="col-6">
                        <img src="{{ asset('image/' . $data->image_4) }}" alt="" class="w-100" style="height:200px">
                        <div style="font-size:10px;font-weight:bold" class="mb-3">{{$data->image_4_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_5 != null)
                    <div class="col-6">
                            <img src="{{ asset('image/' . $data->image_5) }}" alt="" class="w-100" style="height:200px">
                            <div style="font-size:10px;font-weight:bold" class="mb-3">{{$data->image_5_notes}}</div>
                    </div>
                    @endif
                    @if($data->image_6 != null)
                    <div class="col-6">
                        <img src="{{ asset('image/' . $data->image_6) }}" alt="" class="w-100" style="height:200px">
